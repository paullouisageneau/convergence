...
ifeq ($(notdir $(CXX)),em++)
DIR=emscripten
EMFLAGS=-s WASM=1 -s BINARYEN_METHOD=native-wasm -s TOTAL_MEMORY=256MB -s DISABLE_EXCEPTION_CATCHING=0 -s USE_PTHREADS=0 -s USE_WEBGL2=1 -s USE_GLFW=3 -s USE_SDL_IMAGE=2 -s USE_FREETYPE=1
